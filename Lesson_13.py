...
# стандартные магические методы в классах синхронные
# но


# асинхр цикл for
# асинк контекстный менеджер

# асинхронный декоратор (внешняя функция сугубо синхронная)

# асинхр  ыйдшду aiosqlit asingpg

# alembic заставить работать асин - t async
